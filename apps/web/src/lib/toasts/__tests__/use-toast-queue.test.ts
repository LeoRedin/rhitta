...
// =============================================================================
//
// Pure in-memory store, so no DOM stubs. We reset the queue between
// tests and verify defaults, push/dismiss semantics, and id uniqueness.
// =============================================================================

import { beforeEach, describe, expect, it } from 'vitest'
import { useToastQueue } from '../use-toast-queue.js'
