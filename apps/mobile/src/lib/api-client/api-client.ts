...
//   4. `pnpm --filter @rhitta/mobile gen:api-client`         (this script
...
const REGEN_HINT =
  '@rhitta/mobile api-client is the placeholder shipped by Phase 2b Task 5. ' +
  'Run `pnpm --filter @rhitta/mobile gen:api-client` (requires `encore auth login` ' +
  'and one prior `encore run`) to replace this file with the real Encore-generated ' +
  'client. See apps/mobile/src/lib/api-client/README.md and ADR-0020 for details.'
