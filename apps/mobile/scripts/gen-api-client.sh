#!/usr/bin/env bash
# =============================================================================
# gen-api-client.sh — regenerate the typed Encore client for apps/mobile.
# =============================================================================
#
# Per ADR-0020, `apps/mobile` consumes `apps/api` exclusively via the
...
#      writing TypeScript output to apps/mobile/src/lib/api-client/api-client.ts.
#
# Notes:
...
OUTPUT="${REPO_ROOT}/apps/mobile/src/lib/api-client/api-client.ts"
APP_ID="rhitta"
