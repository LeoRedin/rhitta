...
// Navigation custom commands are removed in Rhitta overlay —
// Expo Router handles navigation via file-based routing.
// Restore these when navigation utilities are re-implemented for Expo Router.
